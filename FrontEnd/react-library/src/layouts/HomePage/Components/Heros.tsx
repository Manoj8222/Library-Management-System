    ...
    <div>
      <div className="d-none d-lg-block">
        <div className="row g-0 mt-5">
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead ">
                The library team would love to know whatyou have been reading.
                Whether it is to learn a new skill or grew withing one, we will
        ...
        <div className="row g-0 ">
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              <h1>Our Collenction is always changing!</h1>
              <p className="lead">
                Try to check in daily as our collenciton is always chaning! We
